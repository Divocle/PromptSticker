...
* `--tr / --m / --py / --cpp`：文末添加指令后缀，按下`Ctrl + Enter` 触发翻译、概念解释或代码辅助功能。（Append command suffixes and press `Shift + Enter` to trigger translation, concept explanation, or code assistance.）
